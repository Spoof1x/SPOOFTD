building_upgrade = class({})

function building_upgrade:GetGoldCost()
    local unitName = self:GetCaster():GetUnitName()
    local cost = GetKeyValue1(unitName, "UpgradeCost")
...
function building_upgrade:GetTextureName()
    return ""
end
...
function GetKeyValue1(name,key)
    return GetUnitKV(name,key)
end
